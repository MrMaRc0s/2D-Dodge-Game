...
int main()
{
    ...
    InitWindow(windowDimensions[0], windowDimensions[1], "Dodge or Die");
    ...
    while (!WindowShouldClose())
    {
        ...
        DrawTextureEx(background, bg1Pos, 0.f, 2.f, WHITE);
        Vector2 bg2Pos{bgX + background.width*2, 0.f};
        DrawTextureEx(background, bg2Pos, 0.f, 2.f, WHITE);

        // draw the midground
        Vector2 mg1Pos{mgX, 0.f};
        DrawTextureEx(midground, mg1Pos, 0.f, 2.f, WHITE);
        Vector2 mg2Pos{mgX + midground.width*2, 0.f};
        DrawTextureEx(midground, mg2Pos, 0.f, 2.f, WHITE);

        // draw the foreground
        Vector2 fg1Pos{fgX, 0.f};
        DrawTextureEx(foreground, fg1Pos, 0.f, 2.f, WHITE);
        Vector2 fg2Pos{fgX + foreground.width*2, 0.f};
